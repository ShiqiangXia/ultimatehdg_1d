...
function out = Post_processor(num_sol,GQ_points,numerical_method_info,post_flag,BB)
...
if post_flag == 0 
    temp_q = my_vandermonde_q(GQ_points,N_q);
    temp_u = my_vandermonde_u(GQ_points,N_u);
